...
class Binary : public Expr {
   public:
    ...
    Binary(std::unique_ptr<Expr> left, Token operation, std::unique_ptr<Expr> right)
        : left(std::move(left)), operation(operation), right(std::move(right)) {}
    void acceptHelper(ExprVisitorBase& visitor) const override { visitor.visitBinary(*this); }
};
...
class Grouping : public Expr {
   public:
    ...
    void acceptHelper(ExprVisitorBase& visitor) const override { visitor.visitGrouping(*this); }
};
...
class Literal : public Expr {
   public:
    ...
    void acceptHelper(ExprVisitorBase& visitor) const override { visitor.visitLiteral(*this); }
};
...
class Unary : public Expr {
   public:
    ...
    Unary(Token operation, std::unique_ptr<Expr> right)
        : operation(operation), right(std::move(right)) {}
    void acceptHelper(ExprVisitorBase& visitor) const override { visitor.visitUnary(*this); }
};
